  ...
  <div class="table-box">
    ...
    <div class="table-header clearfix">
      <div class="header-button">
        <el-button type="primary" :icon="icon.CirclePlus" @click="openDrawer('新增')"
          >新增系统账号</el-button
        >
        <el-button type="primary" :icon="icon.Upload" plain @click="batchAdd"
          >批量添加系统账号</el-button
        >
        <el-button type="primary" :icon="icon.Download" plain @click="downloadFile"
          >导出系统账号列表</el-button
        >
        <el-button
          type="danger"
    ...
    >
      ...
      <el-table-column label="操作" fixed="right" width="350px">
        <template #default="scope">
          <el-button type="text" :icon="icon.View" @click="openDrawer('查看', scope.row)"
            >查看</el-button
          >
          <el-button type="text" :icon="icon.EditPen" @click="openDrawer('编辑', scope.row)"
            >编辑</el-button
          >
          <el-button type="text" :icon="icon.Refresh" @click="resetPass(scope.row.id)"
            >重置密码</el-button
          >
          <el-button type="text" :icon="icon.Delete" @click="deleteAccount(scope.row.id)"
            >删除</el-button
          >
        </template>
      </el-table-column>
